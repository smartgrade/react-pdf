 ...
 * @returns 1 or 2
 */
declare const getUTF16Increment: (codePoint: number) => 1 | 2;

export { adjust, asyncCompose, capitalize, castArray, compose, dropLast, evolve, get, getUTF16Increment, isNil, last, mapValues, matchPercent, omit, parseFloat, pick, repeat, reverse, upperFirst, without };
